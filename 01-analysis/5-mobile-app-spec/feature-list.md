...
- **Зона:** АЗ.
- **Доступные функции:**
  - Просмотр списка слотов (по умолчанию — **все предстоящие**, `only_available=false`).
...
- **Бизнес-правила/валидации:** список показывает **все предстоящие** слоты; заполненные
...
|---------|--------------------|
| **Рейтинг инструктора** (1–5 звёзд + отзыв после прогулки) | **Решение зафиксировано: Phase 2** (осознанное сужение скоупа MVP). В MVP не входит. |
