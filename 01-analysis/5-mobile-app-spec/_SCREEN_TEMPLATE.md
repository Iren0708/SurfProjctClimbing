...
- [{Название экрана/шторки}](#название-экранашторки)
  ...
  - [Навигация](#навигация)
    - [Входящая (откуда открывается)](#входящая-откуда-открывается)
    - [Исходящая (куда ведёт)](#исходящая-куда-ведёт)
  - [Входные данные](#входные-данные)
  - [Применяемые логики](#применяемые-логики)
  - [Свойства Bottom Sheet](#свойства-bottom-sheet)
  - [Инициализация](#инициализация)
    - [Диаграмма загрузки](#диаграмма-загрузки)
    - [Запросы при открытии](#запросы-при-открытии)
  ...
  - [Элементы экрана](#элементы-экрана)
    - [1. {Название секции/блока}](#1-название-секцииблока)
    - [2. {Название секции с полями ввода}](#2-название-секции-с-полями-ввода)
  - [Состояния экрана](#состояния-экрана)
    - [Таблица состояний](#таблица-состояний)
    - [Диаграмма переходов](#диаграмма-переходов)
  - [Действия пользователя](#действия-пользователя)
  - [Связанные требования](#связанные-требования)
    - [Функциональные (REQ-FUNC-\*)](#функциональные-req-func-)
    - [Интеграции (REQ-INT-\*)](#интеграции-req-int-)
    - [UI (REQ-UI-\*)](#ui-req-ui-)
    - [Данные (REQ-DATA-\*)](#данные-req-data-)
  - [Критерии приёмки](#критерии-приёмки)
    - [Позитивные сценарии](#позитивные-сценарии)
    - [Негативные сценарии](#негативные-сценарии)
    - [Граничные условия (Edge Cases)](#граничные-условия-edge-cases)
---
